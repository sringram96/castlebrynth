...
- Two closed languages: Descent content speaks the room vocabulary;
  Lots content speaks manifest hooks + effect verbs. Unknown words
  fail at LOAD. A new word/verb/hook is its own Asana task, never a
  side effect.
