...
- **Two rooms are standing in a painting drawn for another one.** The Cleft and
  ...
  `test/unit/assets.test.ts`, and not a licence for a fourth. **The Offertory's
  composed painting is on that ledger whatever its budget says** — it is inside
  the negative-space law now, and the reuse was always debt.
