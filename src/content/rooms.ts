...
export const ROOM_TEMPLATES: Readonly<Record<string, RoomTemplate>> = {
  entry: {
    ...
    details: [
      ...
      {
        // The first of the two hints, and the quieter one. It says a thing
        ...
        id: 'skull',
        at: { x: 0.42, y: 0.86 },
        says: 'A skull on the floor. Small. It has been here longer than the candles. Under the skull, the same hand, scratched smaller.',
      },
      {
        id: 'far-door',
        at: { x: 0.53, y: 0.4 },
